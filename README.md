...
This is an experimental compiler for (something that resembles) a subset of the [Rust programming language](https://rust-lang.org/),
written in Rust.

As backend [LLVM](https://llvm.org/) is used via the [inkwell](https://github.com/TheDan64/inkwell/) library.
...
- [HLR](src/hlr.rs): Slightly more abstract representation of the program, where names are resolved and syntax desugaring has been performed. Serves as basis for typechecking; type information is stored externally.
