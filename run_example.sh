...
cargo run -- \
    ...
    --crate "example" \
    -- "examples/example.mrs" "examples/option.mrs" "examples/vec.mrs" "examples/iter.mrs" "examples/ops.mrs" "examples/box.mrs" "examples/functools.mrs" "examples/mem.mrs" "examples/cmp.mrs"
...
clang-21 "examples/build/example.ll" -o "examples/build/example.out"
