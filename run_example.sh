...
cargo run -- \
    ...
    --crate "example" \
    -- "examples/example.mrs" "examples/option.mrs" "examples/vec.mrs" "examples/iter.mrs" "examples/ops.mrs"
...
clang-21 "examples/build/example.ll" "examples/stdlib.ll" -o "examples/build/example.out"
